...
class Cookie {
     ...
     * @return bool
     */
    public function set($name, $value, $expiration = null, $path = null, $domain = null, $secure = null, $http_only = null) {
        $name = $this->config['pre'] . $name;
        ...
        return setcookie($name, json_encode($value), $expiration, $path, $domain, $secure, $http_only);
    }
